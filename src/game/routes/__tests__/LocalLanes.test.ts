...
import type { GameState, ActiveRoute, Planet, StarSystem } from '../../../data/types.ts';
...
const planets: Planet[] = [
  { id: 'planet-0-0-0', name: 'Alpha', systemId: 'system-0-0', type: 'terran', x: 10, y: 10, population: 100 },
  { id: 'planet-0-0-1', name: 'Beta', systemId: 'system-0-0', type: 'mining', x: 20, y: 20, population: 50 },
  { id: 'planet-0-1-0', name: 'Gamma', systemId: 'system-0-1', type: 'agricultural', x: 100, y: 100, population: 80 },
];

const systems: StarSystem[] = [
  { id: 'system-0-0', name: 'Sol', sectorId: 'sector-0', empireId: 'empire-1', x: 0, y: 0, starColor: 0xffff00 },
  { id: 'system-0-1', name: 'Alpha Centauri', sectorId: 'sector-0', empireId: 'empire-1', x: 100, y: 100, starColor: 0xffa500 },
];

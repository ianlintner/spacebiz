...
export const CONTEXTUAL_TIPS: MessageTemplate[] = [
  ...
  {
    id: "tip_contracts_1",
    text: "Tip: Contracts reward you for delivering specific cargo on a route. They're the fastest way to earn bonus cash and unlock tariff reductions.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_contracts_2",
    text: "Tip: Keep a ship assigned to contracted routes. Going too many turns without one risks contract failure and losing your deposit.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_contracts_3",
    text: "Tip: Completed contracts sometimes reduce tariffs between empires. Check the reward details before committing.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_tech_1",
    text: "Tip: Research points accumulate each turn. Prioritize techs that match your strategy — route expansion, cost reduction, or trade advantages.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_tech_2",
    text: "Tip: Higher-tier technologies are more powerful but cost more RP. Plan your research path ahead.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_tech_3",
    text: "Tip: Some techs grant extra route slots. If you're running out of slots, check the Logistics branch.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_empire_1",
    text: "Tip: You can only trade with empires you've unlocked. Expand access by unlocking empires adjacent to your existing territory.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_empire_2",
    text: "Tip: Each empire has its own trade policies. Some ban imports of certain cargo — check before building routes.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_empire_3",
    text: "Tip: Inter-empire routes incur tariffs. The higher the tariff, the more it eats into your margins.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_slots_1",
    text: "Tip: Route slots are limited. Cancel underperforming routes to free slots for better opportunities.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
  {
    id: "tip_mothball_1",
    text: "Tip: Mothballing idle ships reduces maintenance costs. Reactivate them when new routes open up.",
    mood: "analyzing",
    priority: 3,
    context: "tip",
  },
...
export const WARNING_MESSAGES: MessageTemplate[] = [
  ...
  {
    id: "warn_underutilization",
    text: "Caution: Fleet capacity is under 50% utilized. Consider opening new routes to put your capacity pool to work.",
    mood: "analyzing",
    priority: 2,
    context: "warning",
  },
  {
    id: "warn_contract_at_risk",
    text: "Warning: A contract route has no assigned ship. If this continues, the contract will fail and your deposit is forfeit.",
    mood: "alert",
    priority: 1,
    context: "warning",
  },
  {
    id: "warn_route_slots_full",
    text: "Warning: All route slots are in use. Cancel a route or research slot upgrades to expand further.",
    mood: "alert",
    priority: 2,
    context: "warning",
  },
  {
    id: "warn_no_research",
    text: "Caution: No active research project. You're leaving research points on the table each turn.",
    mood: "alert",
    priority: 2,
    context: "warning",
  },

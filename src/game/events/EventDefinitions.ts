  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You commit resources and gain full trade benefits plus reputation.",
      effects: [
    ...
    },
    {
      ...
      outcomeDescription:
        "You negotiate a limited commitment. Smaller benefit but more flexibility.",
    ...
    },
    {
      ...
      outcomeDescription:
        "You politely decline. No benefit, but no obligation either.",
      effects: [],
    },
  ],
};
...
const pirateActivity: EventTemplate = {
  ...
  choiceOptions: [
    ...
    },
    {
      ...
      outcomeDescription:
        "You engage the pirates. 50% chance to rout them and gain reputation, 50% chance route stays blocked.",
    ...
    },
    {
      ...
      outcomeDescription:
        "You route around the pirates. Revenue drops 15% but your ships stay safe.",
      effects: [{ type: "modifyDemand", value: -0.15 }],
    },
  ],
};
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "Ships sit out the storm. No revenue this turn but ships are safe.",
      effects: [{ type: "modifyDemand", value: -1.0 }],
    },
    {
      id: "push_through",
      label: "Push through the solar flare",
      outcomeDescription:
        "You brave the storm. Risk condition loss of 10-20 points.",
      effects: [{ type: "modifySpeed", value: -0.1 }],
    },
    {
      id: "alternate_route",
      label: "Take an alternate route",
      outcomeDescription:
        "Safer path costs 10% revenue but ships arrive intact.",
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You stock up at premium prices. Fleet keeps running smoothly.",
      effects: [
        { type: "modifyCash", value: -3000 },
    ...
    },
    {
      ...
      outcomeDescription:
        "You ground your routes to save fuel. No revenue from grounded routes this turn.",
    ...
    },
    {
      ...
      outcomeDescription:
        "Ships take a detour to fuel up. 2-turn delay but cheaper fuel.",
      effects: [{ type: "modifySpeed", value: -0.3 }],
    },
  ],
};
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You salvage the wreck and recover usable components.",
      effects: [
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You comply with the embargo. Route suspended, reputation preserved.",
      effects: [
    ...
    },
    {
      ...
      outcomeDescription:
        "You defy the embargo. Routes stay open but you risk reputation damage.",
      effects: [{ type: "modifyReputation", value: -5 }],
    },
    {
      ...
      outcomeDescription:
        "You pay to negotiate a reduced penalty. Partial route access maintained.",
      effects: [
        { type: "modifyCash", value: -2000 },
        { type: "modifyReputation", value: -1 },
      ],
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You comply. Routes grounded, but reputation with both empires stays neutral.",
    ...
    },
    {
      ...
      outcomeDescription:
        "You defy the embargo. Risk reputation damage but keep revenue.",
      effects: [
        { type: "modifyReputation", value: -5 },
        { type: "modifyCash", value: 3000 },
      ],
    },
    {
      ...
      outcomeDescription:
        "Longer routes but you avoid the embargo zone entirely.",
      effects: [{ type: "modifySpeed", value: -0.2 }],
    },
  ],
};
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "High risk, high reward. Big cash but reputation takes a hit.",
      effects: [
        { type: "modifyCash", value: 25000 },
        { type: "modifyReputation", value: -10 },
      ],
    },
    {
      ...
      outcomeDescription:
        "You tip off the empire. Reputation boost, small cash reward.",
      effects: [
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You back one side. If they win you gain major bonuses; if they lose, penalties.",
      effects: [
        { type: "modifyReputation", value: 5 },
    ...
    },
    {
      ...
      label: "Stay neutral",
      outcomeDescription:
        "You stay out of it. Small penalty from both empires but routes stay accessible.",
      effects: [{ type: "modifyReputation", value: -3 }],
    },
    {
      id: "mediate_war",
      ...
      outcomeDescription:
        "You spend resources to broker peace. Expensive but could prevent prolonged disruption.",
      effects: [
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You spend cash to set up new routes early, gaining first-mover advantage.",
      effects: [
        { type: "modifyCash", value: -3000 },
        { type: "modifyReputation", value: 5 },
    ...
    },
    {
      ...
      outcomeDescription:
        "You take a cautious approach. No investment, but routes stay open.",
      effects: [],
    },
  ],
};
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You invest in this opportunity and see amplified gains across allied routes.",
      effects: [
        { type: "modifyCash", value: -2000 },
        { type: "modifyReputation", value: 8 },
    ...
    },
    {
      ...
      outcomeDescription:
        "You enjoy the natural benefits without extra commitment.",
      effects: [{ type: "modifyReputation", value: 2 }],
    },
  ],
};
  ...
  choiceOptions: [
    {
      ...
      outcomeDescription:
        "You pull out quickly. Revenue drops but ships stay safe.",
    ...
    },
    {
      ...
      outcomeDescription:
        "You file a formal protest. Small chance to reverse closure, costs reputation if it fails.",
      effects: [
    ...
    },
    {
      ...
      outcomeDescription:
        "You invest in diplomacy. Expensive but builds reputation and may reopen borders faster.",
      effects: [

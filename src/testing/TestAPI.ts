  ...
  return {
    ...
    help: () => {
      const lines = [
        ...
        "  __sft.actions.triggerDilemma(templateId?)",
        "  __sft.actions.forceGameOver(reason?)",
        "  __sft.actions.startSandboxPlayback({ seed, turns })",
        "  __sft.actions.startSandboxSummary({ seed, turns })",
        "",
        "Async helpers:",
